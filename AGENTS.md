...
public/thumbnails/             # optional per-project preview images (<repo>.png)
```
...
when the set of repos changed). Content still to fill by hand (subtitles,
thumbnails, site copy...) is tracked in
